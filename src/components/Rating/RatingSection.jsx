...
const RatingSection = () => {
    return (
      <div className="my-4 bg-linear-to-r from-[#4F39F6] to-[#9514FA]">
        <div className="container mx-auto flex text-center text-white py-8 px-6 bg-linear-to-r from-[#4F39F6] to-[#9514FA]">
